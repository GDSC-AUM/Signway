...
@Composable
fun displayW2Sign(navController: NavHostController)
{
    Box(
        modifier = Modifier
            .fillMaxSize()
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally,modifier = Modifier,
            ...
            Image(
                painter = painterResource(R.drawable.w_goodbye),
                contentDescription = "icons of options",
            ...
            Row() {
                ...
                )
                {
                    Text(
                        ...
                        style = MaterialTheme.typography.h2,
                        fontSize = 35.sp,
                        modifier = Modifier.clickable { navController.navigate(Screen.WSign1.route) },
                    )
                }
...
fun previewSign28()
{
    displayW2Sign( navController = rememberNavController())
}
