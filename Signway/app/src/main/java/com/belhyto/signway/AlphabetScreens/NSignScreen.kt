...
@Composable
fun displayNSign(navController: NavHostController)
{
    Box(
        modifier = Modifier
            .fillMaxSize()
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally,modifier = Modifier,
            ...
            Image(
                painter = painterResource(R.drawable.a_n),
                contentDescription = "icons of options",
            ...
            Row() {
                ...
                Button(
                    ...
                    modifier = Modifier
                        .width(width = 150.dp)
                        .height(70.dp)
                    .clickable { navController.navigate(route = Screen.ASign13.route) },
                ...
                )
                {
                    Text(
                        ...
                        style = MaterialTheme.typography.h2,
                        fontSize = 35.sp,
                        modifier = Modifier.clickable { navController.navigate(Screen.ASign13.route) },
                    )
                }
                ...
                Button(
                    ...
                    modifier = Modifier
                        .width(width = 150.dp)
                        .height(70.dp)
                    .clickable { navController.navigate(route = Screen.ASign15.route) },
                    elevation = ButtonDefaults.elevation(10.dp),
                    colors = ButtonDefaults.buttonColors(
                        backgroundColor = MaterialTheme.colors.secondary,
                        contentColor = Color.White
                ...
                )
                {
                    Text(
                        ...
                        style = MaterialTheme.typography.h2,
                        fontSize = 35.sp,
                        modifier = Modifier.clickable { navController.navigate(Screen.ASign15.route) },
                    )
...
fun previewSign14()
{
    displayNSign( navController = rememberNavController())
}