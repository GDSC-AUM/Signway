...
@Composable
fun displayGSign(navController: NavHostController)
{
    Box(
        modifier = Modifier
            .fillMaxSize()
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally,modifier = Modifier,
            ...
            Image(
                painter = painterResource(R.drawable.a_g),
                contentDescription = "icons of options",
            ...
            Row() {
                ...
                Button(
                    ...
                    modifier = Modifier
                        .width(width = 150.dp)
                        .height(70.dp)
                    .clickable { navController.navigate(route = Screen.ASign6.route) },
                ...
                )
                {
                    Text(
                        ...
                        style = MaterialTheme.typography.h2,
                        fontSize = 35.sp,
                        modifier = Modifier.clickable { navController.navigate(Screen.ASign6.route) },
                    )
                }
...
fun previewSign7()
{
    displayGSign( navController = rememberNavController())
}