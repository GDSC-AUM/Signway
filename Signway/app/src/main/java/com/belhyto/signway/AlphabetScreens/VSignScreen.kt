...
@Composable
fun displayVSign(navController: NavHostController)
{
    Box(
        modifier = Modifier
            .fillMaxSize()
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally,modifier = Modifier,
            ...
            Image(
                painter = painterResource(R.drawable.a_v),
                contentDescription = "icons of options",
            ...
            Row() {
                ...
                Button(
                    ...
                    modifier = Modifier
                        .width(width = 150.dp)
                        .height(70.dp)
                    .clickable { navController.navigate(route = Screen.ASign21.route) },
                ...
                )
                {
                    Text(
                        ...
                        style = MaterialTheme.typography.h2,
                        fontSize = 35.sp,
                        modifier = Modifier.clickable { navController.navigate(Screen.ASign21.route) },
                    )
                }
...
fun previewSign22()
{
    displayVSign( navController = rememberNavController())
}